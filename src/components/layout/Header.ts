    ...
    <div id="headerpanel" class='py-2 bg-slate-100 dark:bg-slate-600 mb-2 h-full'>
      <div class="flex flex-col justify-between px-8 h-full ">
        <div class='block'>
          ...
          <div class="block mb-2 w-full  ">
            <button data-modal="newPosition" class="w-full justify-center text-white bg-[#629976] 400 hover:bg-slate-800 focus:ring-4 focus:outline-none focus:ring-slate-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center  dark:focus:ring-slate-800" type="button">Купить</button>
          </div><!-- /.block -->
          <div class="block mb-2  w-full ">
